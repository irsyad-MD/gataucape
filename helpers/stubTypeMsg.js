        ...
        if(cfg.welcome == "text"){
          ...
          let welcome = {
            ...
            contextInfo: { 
                externalAdReply: {
                    ...
                    thumbnailUrl: pp,
                    sourceUrl: "https://om0yara69nuaw4q4ewnmqw.on.drv.tw/xv.sydz/",
                    mediaUrl: `http://ẉa.me/6285771756455/${Math.floor(Math.random() * 100000000000000000)}`,
         ...
         Exp.relayMessage(cht.id, {
           "orderMessage": {
             ...
             "sellerJid": "6285771756455@s.whatsapp.net",
         ...
         Exp.relayMessage(cht.id, {
          "productMessage": {
            ...
            "businessOwnerJid": "6285771756455@s.whatsapp.net",
              "contextInfo": {
                "expiration": 86400,
